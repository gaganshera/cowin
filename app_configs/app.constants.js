module.exports = {
  ...
  districts: {
    ...
    3: [
      { district_id: 22, district_name: "Anjaw" },
      { district_id: 20, district_name: "Changlang" },
      { district_id: 25, district_name: "Dibang Valley" },
      { district_id: 23, district_name: "East Kameng" },
      { district_id: 42, district_name: "East Siang" },
      { district_id: 17, district_name: "Itanagar Capital Complex" },
      { district_id: 24, district_name: "Kamle" },
      { district_id: 27, district_name: "Kra Daadi" },
      { district_id: 21, district_name: "Kurung Kumey" },
      { district_id: 33, district_name: "Lepa Rada" },
      { district_id: 29, district_name: "Lohit" },
      { district_id: 40, district_name: "Longding" },
      { district_id: 31, district_name: "Lower Dibang Valley" },
      { district_id: 18, district_name: "Lower Siang" },
      { district_id: 32, district_name: "Lower Subansiri" },
      { district_id: 36, district_name: "Namsai" },
      { district_id: 19, district_name: "Pakke Kessang" },
      { district_id: 39, district_name: "Papum Pare" },
      { district_id: 35, district_name: "Shi Yomi" },
      { district_id: 37, district_name: "Siang" },
      { district_id: 30, district_name: "Tawang" },
      { district_id: 26, district_name: "Tirap" },
      { district_id: 34, district_name: "Upper Siang" },
      { district_id: 41, district_name: "Upper Subansiri" },
      { district_id: 28, district_name: "West Kameng" },
      { district_id: 38, district_name: "West Siang" },
    ],
    4: [
      { district_id: 46, district_name: "Baksa" },
      { district_id: 47, district_name: "Barpeta" },
      { district_id: 765, district_name: "Biswanath" },
      { district_id: 57, district_name: "Bongaigaon" },
      { district_id: 66, district_name: "Cachar" },
      { district_id: 766, district_name: "Charaideo" },
      { district_id: 58, district_name: "Chirang" },
      { district_id: 48, district_name: "Darrang" },
      { district_id: 62, district_name: "Dhemaji" },
      { district_id: 59, district_name: "Dhubri" },
      { district_id: 43, district_name: "Dibrugarh" },
      { district_id: 67, district_name: "Dima Hasao" },
      { district_id: 60, district_name: "Goalpara" },
      { district_id: 53, district_name: "Golaghat" },
      { district_id: 68, district_name: "Hailakandi" },
      { district_id: 764, district_name: "Hojai" },
      { district_id: 54, district_name: "Jorhat" },
      { district_id: 49, district_name: "Kamrup Metropolitan" },
      { district_id: 50, district_name: "Kamrup Rural" },
      { district_id: 51, district_name: "Karbi-Anglong" },
      { district_id: 69, district_name: "Karimganj" },
      { district_id: 61, district_name: "Kokrajhar" },
      { district_id: 63, district_name: "Lakhimpur" },
      { district_id: 767, district_name: "Majuli" },
      { district_id: 55, district_name: "Morigaon" },
      { district_id: 56, district_name: "Nagaon" },
      { district_id: 52, district_name: "Nalbari" },
      { district_id: 44, district_name: "Sivasagar" },
      { district_id: 64, district_name: "Sonitpur" },
      { district_id: 768, district_name: "South Salmara Mankachar" },
      { district_id: 45, district_name: "Tinsukia" },
      { district_id: 65, district_name: "Udalguri" },
      { district_id: 769, district_name: "West Karbi Anglong" },
    ],
    5: [
    ...
    6: [{ district_id: 108, district_name: "Chandigarh" }],
    7: [
      ...
      { district_id: 136, district_name: "Gaurela Pendra Marwahi " },
      { district_id: 121, district_name: "Janjgir-Champa" },
      { district_id: 122, district_name: "Jashpur" },
      { district_id: 123, district_name: "Kanker" },
      { district_id: 135, district_name: "Kawardha" },
      { district_id: 124, district_name: "Kondagaon" },
      { district_id: 125, district_name: "Korba" },
      { district_id: 126, district_name: "Koriya" },
      { district_id: 127, district_name: "Mahasamund" },
      { district_id: 128, district_name: "Mungeli" },
      { district_id: 129, district_name: "Narayanpur" },
      { district_id: 130, district_name: "Raigarh" },
      { district_id: 109, district_name: "Raipur" },
      { district_id: 131, district_name: "Rajnandgaon" },
      { district_id: 132, district_name: "Sukma" },
      { district_id: 133, district_name: "Surajpur" },
      { district_id: 134, district_name: "Surguja" },
    ],
    8: [{ district_id: 137, district_name: "Dadra and Nagar Haveli" }],
    9: [
    ...
    10: [
      { district_id: 151, district_name: "North Goa" },
      { district_id: 152, district_name: "South Goa" },
    ],
    11: [
      { district_id: 154, district_name: "Ahmedabad" },
      { district_id: 770, district_name: "Ahmedabad Corporation" },
      { district_id: 174, district_name: "Amreli" },
      { district_id: 179, district_name: "Anand" },
      { district_id: 158, district_name: "Aravalli" },
      { district_id: 159, district_name: "Banaskantha" },
      { district_id: 180, district_name: "Bharuch" },
      { district_id: 175, district_name: "Bhavnagar" },
      ...
      { district_id: 163, district_name: "Dang" },
      ...
      { district_id: 177, district_name: "Gir Somnath" },
      { district_id: 169, district_name: "Jamnagar" },
      ...
      { district_id: 170, district_name: "Kutch" },
      { district_id: 183, district_name: "Mahisagar" },
      { district_id: 160, district_name: "Mehsana" },
      { district_id: 171, district_name: "Morbi" },
      { district_id: 184, district_name: "Narmada" },
      { district_id: 164, district_name: "Navsari" },
      { district_id: 185, district_name: "Panchmahal" },
      { district_id: 161, district_name: "Patan" },
      { district_id: 172, district_name: "Porbandar" },
      { district_id: 173, district_name: "Rajkot" },
      { district_id: 775, district_name: "Rajkot Corporation" },
      { district_id: 162, district_name: "Sabarkantha" },
      { district_id: 165, district_name: "Surat" },
      { district_id: 776, district_name: "Surat Corporation" },
      { district_id: 157, district_name: "Surendranagar" },
    ...
    13: [
      { district_id: 219, district_name: "Bilaspur" },
      { district_id: 214, district_name: "Chamba" },
      { district_id: 217, district_name: "Hamirpur" },
      { district_id: 213, district_name: "Kangra" },
      { district_id: 216, district_name: "Kinnaur" },
      { district_id: 211, district_name: "Kullu" },
      { district_id: 210, district_name: "Lahaul Spiti" },
      { district_id: 215, district_name: "Mandi" },
      { district_id: 208, district_name: "Shimla" },
      { district_id: 212, district_name: "Sirmaur" },
      { district_id: 209, district_name: "Solan" },
      { district_id: 218, district_name: "Una" },
    ],
    14: [
      { district_id: 224, district_name: "Anantnag" },
      { district_id: 223, district_name: "Bandipore" },
      { district_id: 225, district_name: "Baramulla" },
      { district_id: 229, district_name: "Budgam" },
      { district_id: 232, district_name: "Doda" },
      { district_id: 228, district_name: "Ganderbal" },
      { district_id: 230, district_name: "Jammu" },
      { district_id: 234, district_name: "Kathua" },
      { district_id: 231, district_name: "Kishtwar" },
      { district_id: 221, district_name: "Kulgam" },
      { district_id: 226, district_name: "Kupwara" },
      { district_id: 238, district_name: "Poonch" },
      { district_id: 227, district_name: "Pulwama" },
      { district_id: 237, district_name: "Rajouri" },
      { district_id: 235, district_name: "Ramban" },
      { district_id: 239, district_name: "Reasi" },
      { district_id: 236, district_name: "Samba" },
      { district_id: 222, district_name: "Shopian" },
      { district_id: 220, district_name: "Srinagar" },
      { district_id: 233, district_name: "Udhampur" },
    ],
    15: [
    ...
    18: [
      { district_id: 309, district_name: "Kargil" },
      { district_id: 310, district_name: "Leh" },
    ],
    19: [
      { district_id: 796, district_name: "Agatti Island" },
      { district_id: 311, district_name: "Lakshadweep" },
    ],
    20: [
    ...
    22: [
      { district_id: 398, district_name: "Bishnupur" },
      { district_id: 399, district_name: "Chandel" },
      { district_id: 400, district_name: "Churachandpur" },
      { district_id: 401, district_name: "Imphal East" },
      { district_id: 402, district_name: "Imphal West" },
      { district_id: 410, district_name: "Jiribam" },
      { district_id: 413, district_name: "Kakching" },
      { district_id: 409, district_name: "Kamjong" },
      { district_id: 408, district_name: "Kangpokpi" },
      { district_id: 412, district_name: "Noney" },
      { district_id: 411, district_name: "Pherzawl" },
      { district_id: 403, district_name: "Senapati" },
      { district_id: 404, district_name: "Tamenglong" },
      { district_id: 407, district_name: "Tengnoupal" },
      { district_id: 405, district_name: "Thoubal" },
      { district_id: 406, district_name: "Ukhrul" },
    ],
    23: [
      { district_id: 424, district_name: "East Garo Hills" },
      { district_id: 418, district_name: "East Jaintia Hills" },
      { district_id: 414, district_name: "East Khasi Hills" },
      { district_id: 423, district_name: "North Garo Hills" },
      { district_id: 417, district_name: "Ri-Bhoi" },
      { district_id: 421, district_name: "South Garo Hills" },
      { district_id: 422, district_name: "South West Garo Hills" },
      { district_id: 415, district_name: "South West Khasi Hills" },
      { district_id: 420, district_name: "West Garo Hills" },
      { district_id: 416, district_name: "West Jaintia Hills" },
      { district_id: 419, district_name: "West Khasi Hills" },
    ],
    24: [
      { district_id: 425, district_name: "Aizawl East" },
      { district_id: 426, district_name: "Aizawl West" },
      { district_id: 429, district_name: "Champhai" },
      { district_id: 428, district_name: "Kolasib" },
      { district_id: 432, district_name: "Lawngtlai" },
      { district_id: 431, district_name: "Lunglei" },
      { district_id: 427, district_name: "Mamit" },
      { district_id: 430, district_name: "Serchhip" },
      { district_id: 433, district_name: "Siaha" },
    ],
    25: [
      { district_id: 434, district_name: "Dimapur" },
      { district_id: 444, district_name: "Kiphire" },
      { district_id: 441, district_name: "Kohima" },
      { district_id: 438, district_name: "Longleng" },
      { district_id: 437, district_name: "Mokokchung" },
      { district_id: 439, district_name: "Mon" },
      { district_id: 435, district_name: "Peren" },
      { district_id: 443, district_name: "Phek" },
      { district_id: 440, district_name: "Tuensang" },
      { district_id: 436, district_name: "Wokha" },
      { district_id: 442, district_name: "Zunheboto" },
    ],
    26: [
    ...
    27: [
      { district_id: 476, district_name: "Karaikal" },
      { district_id: 477, district_name: "Mahe" },
      { district_id: 475, district_name: "Puducherry" },
      { district_id: 478, district_name: "Yanam" },
    ],
    28: [
      { district_id: 485, district_name: "Amritsar" },
      { district_id: 483, district_name: "Barnala" },
      { district_id: 493, district_name: "Bathinda" },
      { district_id: 499, district_name: "Faridkot" },
      { district_id: 484, district_name: "Fatehgarh Sahib" },
      { district_id: 487, district_name: "Fazilka" },
      { district_id: 480, district_name: "Ferozpur" },
      { district_id: 489, district_name: "Gurdaspur" },
      { district_id: 481, district_name: "Hoshiarpur" },
      { district_id: 492, district_name: "Jalandhar" },
      { district_id: 479, district_name: "Kapurthala" },
      { district_id: 488, district_name: "Ludhiana" },
      { district_id: 482, district_name: "Mansa" },
      { district_id: 491, district_name: "Moga" },
      { district_id: 486, district_name: "Pathankot" },
      { district_id: 494, district_name: "Patiala" },
      { district_id: 497, district_name: "Rup Nagar" },
      { district_id: 498, district_name: "Sangrur" },
      { district_id: 496, district_name: "SAS Nagar" },
      { district_id: 500, district_name: "SBS Nagar" },
      { district_id: 490, district_name: "Sri Muktsar Sahib" },
      { district_id: 495, district_name: "Tarn Taran" },
    ],
    29: [
    ...
    30: [
      { district_id: 535, district_name: "East Sikkim" },
      { district_id: 537, district_name: "North Sikkim" },
      { district_id: 538, district_name: "South Sikkim" },
      { district_id: 536, district_name: "West Sikkim" },
    ],
    31: [
      { district_id: 779, district_name: "Aranthangi" },
    ...
    32: [
      { district_id: 582, district_name: "Adilabad" },
    ...
    33: [
      { district_id: 614, district_name: "Dhalai" },
      { district_id: 615, district_name: "Gomati" },
      { district_id: 616, district_name: "Khowai" },
      { district_id: 617, district_name: "North Tripura" },
      { district_id: 618, district_name: "Sepahijala" },
      { district_id: 619, district_name: "South Tripura" },
      { district_id: 620, district_name: "Unakoti" },
      { district_id: 621, district_name: "West Tripura" },
    ],
    34: [
    ...
    35: [
      { district_id: 704, district_name: "Almora" },
      { district_id: 707, district_name: "Bageshwar" },
      { district_id: 699, district_name: "Chamoli" },
      { district_id: 708, district_name: "Champawat" },
      { district_id: 697, district_name: "Dehradun" },
      { district_id: 702, district_name: "Haridwar" },
      { district_id: 709, district_name: "Nainital" },
      { district_id: 698, district_name: "Pauri Garhwal" },
      { district_id: 706, district_name: "Pithoragarh" },
      { district_id: 700, district_name: "Rudraprayag" },
      { district_id: 701, district_name: "Tehri Garhwal" },
      { district_id: 705, district_name: "Udham Singh Nagar" },
      { district_id: 703, district_name: "Uttarkashi" },
    ],
    36: [
      { district_id: 710, district_name: "Alipurduar District" },
      { district_id: 711, district_name: "Bankura" },
      {
        district_id: 712,
        district_name: "Basirhat HD (North 24 Parganas)",
      },
      { district_id: 713, district_name: "Birbhum" },
      { district_id: 714, district_name: "Bishnupur HD (Bankura)" },
      { district_id: 715, district_name: "Cooch Behar" },
      { district_id: 783, district_name: "COOCHBEHAR" },
      { district_id: 716, district_name: "Dakshin Dinajpur" },
      { district_id: 717, district_name: "Darjeeling" },
      {
        district_id: 718,
        district_name: "Diamond Harbor HD (S 24 Parganas)",
      },
      { district_id: 719, district_name: "East Bardhaman" },
      { district_id: 720, district_name: "Hoogly" },
      { district_id: 721, district_name: "Howrah" },
      { district_id: 722, district_name: "Jalpaiguri" },
      { district_id: 723, district_name: "Jhargram" },
      { district_id: 724, district_name: "Kalimpong" },
      { district_id: 725, district_name: "Kolkata" },
      { district_id: 726, district_name: "Malda" },
      { district_id: 727, district_name: "Murshidabad" },
      { district_id: 728, district_name: "Nadia" },
      {
        district_id: 729,
        district_name: "Nandigram HD (East Medinipore)",
      },
      { district_id: 730, district_name: "North 24 Parganas" },
      { district_id: 731, district_name: "Paschim Medinipore" },
      { district_id: 732, district_name: "Purba Medinipore" },
      { district_id: 733, district_name: "Purulia" },
      { district_id: 734, district_name: "Rampurhat HD (Birbhum)" },
      { district_id: 735, district_name: "South 24 Parganas" },
      { district_id: 736, district_name: "Uttar Dinajpur" },
      { district_id: 737, district_name: "West Bardhaman" },
    ],
    37: [
      { district_id: 138, district_name: "Daman" },
      { district_id: 139, district_name: "Diu" },
    ],
  },
};
